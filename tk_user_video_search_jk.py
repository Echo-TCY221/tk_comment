...
from tk_user_video_search import Search
...
define('port', default=8902, type=int)
...
class BidUnite(tornado.web.RequestHandler):
    ...
    def _process(self, req_dict):
        print(req_dict)
        result = Search.run(req_dict['user_sec_id'], req_dict['timestamp'])
        # pass
        return result
...
def make_app():
    return tornado.web.Application(handlers=[
        (r'/', MainHandler),
        (r'/tk_user_video_search', BidUnite),
    ], request_timeout=600)
